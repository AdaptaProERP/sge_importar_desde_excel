...
PROCE MAIN(oCom)
   ...
   LOCAL cRanPe:="",nPorPe:=0   //AG20170926
...
//   ENDIF
   ...
   cEmpresa:=oDp:cEmpresa // 03/04/2024 oDp:cEmpLargo // DR20130618a oDp:cEmpresa
...
*******BUSCA LOS DOCUMENTOS QUE VAN EN EL LIBRO DE COMPRAS
  //  aTipDoc:=ASQL("SELECT TDC_TIPO FROM DPTIPDOCPRO WHERE TDC_LIBCOM=1") JN 03/04/2024 INNECESARIO SUSTITIDO POR INNER JOIN
...
//  " AND " + GetWhereOr("DOC_TIPDOC",aTipDoc)+; 04/04/2024, sustituido por TDC_LIBCOM=1
...
//IIF( nBase<>0,"" ,IIF(oCom:lCColRti,"",CHR(13)) )
         ...
         *oHoja:Range( cRange1 ):Borders():LineStyle  := 1
         ...
         IF LEN(cClip)>20000
            ...
            IF oCom:nCForm=1 .OR. oCom:nCForm=3 .OR. oCom:nCForm=4
               // DR20110606a. Se amplÃ­a el tamaÃ±o del rango
/*
...
//         oHoja:Range(cRange2):Set( "NumberFormat", "dd/mm/aaaa")
   ...
   ENDIF
   IF oCom:nCForm=1 .OR. oCom:nCForm=3 .OR. oCom:nCForm=4
      // DR20110606a. Se amplÃ­a tamaÃ±o del rango.
/*
// DR20130618a. Esto ya no va. Sustituimos por el de abajo.
...
*****AG20170926
          IF nI=6
             oHoja:Cells( nRow, 8):Value := "Sum. de las Compras Internas Afectas en Alicuota Pag. Elect."
          ENDIF
...
*****AG20170926
          IF nI=7
             oHoja:Cells( nRow, 8):Value := "Sum. de las Compras Internas Afectas en Alicuota Rebaja Dec. 3085 9%"
          ENDIF

          IF nI=8
             oHoja:Cells( nRow, 8):Value := "Sum. de las Compras Internas Afectas en Alicuota Rebaja Dec. 3085 7%"
          ENDIF
...
*****AG20170926
             IF nI=3 .OR. nI=6 .OR. nI=7 .OR. nI=8
                ...
                IF nI=3
                   nPorPe:="16" // jn 04/04/2023 el IVA debe ser el 16% debe reemplazar la suma de las columnas
                ENDIF
