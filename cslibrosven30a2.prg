...
PROCE MAIN(oVen)
   ...
   LOCAL oExcel,oHoja,oHoja2,oHojax,oHojaSuma,oLanguage,nRowIni,nRowIni2,nRowFin,nRowFin2,cRange1,cRange2,cRange3,cRange4,aResumen:=ARRAY(6,4),nRowInicab,lContri
   // Revisión 03/03/2006
...
///AG20080529
   ...
   LOCAL cRanPe:="",nPorPe   //AG20170212
