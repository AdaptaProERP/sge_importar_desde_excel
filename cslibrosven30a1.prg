...
//                  (DR20110728a) Se habilita campo CEDULA en caso de que esté lleno
//                  (DR20110915a) Se habilita posibilidad de que las retenciones fuera de fecha entre en el grupo "Fuera del Período"
//                  (DR20110915b) Se cambia fecha de documento en "Ajustes". Ahora será la fecha de la retención.Además, se agrega 
...
*****AG20080529
      ...
      IF lRti
         ...
         // DR20110915a. Si está activa la variable de Retenciones fuera de fecha la validación es distinta. Solo si la fecha es igual,
         //              se excluye
      ...
      IF !EMPTY(cNumRti)
         ...
         // DR20110915a. Si la variable lVRetFec está activa, entonces con solo ser distinta la fecha ya se excluye
         // DR20110915c. Si lRetAju está encendida, tampoco debe asociar retenciones
/*
...
// MsgInfo("Salio del While")
      ...
      nImp8:=nIvaRed
      nBase15:=nBase-nBase8
      // DR20110915a. Si la variable lVRetFec está activa, la condición cambia.
/*
// DR20120316a
...
/*
                   IF nI=6
                      cRanPe:=cRanpe+"+SUMAR.SI(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe2+"%;Q"+ALLTRIM(STR(INT(nRowIni2)))+":Q"+ALLTRIM(STR(INT(nRowFin)))+")"
                      cRanPe:=cRanpe+"+SUMAR.SI(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe3+"%;Q"+ALLTRIM(STR(INT(nRowIni2)))+":Q"+ALLTRIM(STR(INT(nRowFin)))+")"
                   ENDIF
*/
*****AG20170926
                ELSE
...
/*
                   IF nI=6
                      cRanPe:=cRanPe+"+SUM.IF(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe2+"%;Q"+ALLTRIM(STR(INT(nRowIni2)))+":Q"+ALLTRIM(STR(INT(nRowFin)))+")"
                      cRanPe:=cRanPe+"+SUM.IF(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe3+"%;Q"+ALLTRIM(STR(INT(nRowIni2)))+":Q"+ALLTRIM(STR(INT(nRowFin)))+")"
                   ENDIF
*/
*****AG20170926
                ENDIF
...
/*
                   IF nI=6
                      cRanPe:=cRanPe+"+SUMAR.SI(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe2+"%;T"+ALLTRIM(STR(INT(nRowIni2)))+":T"+ALLTRIM(STR(INT(nRowFin)))+")"
                      cRanPe:=cRanPe+"+SUMAR.SI(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe3+"%;T"+ALLTRIM(STR(INT(nRowIni2)))+":T"+ALLTRIM(STR(INT(nRowFin)))+")"
                   ENDIF
*/
*****AG20170926
...
/*
                   IF nI=6
                      cRanPe:=cRanPe+"+SUM.IF(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe2+"%;T"+ALLTRIM(STR(INT(nRowIni2)))+":T"+ALLTRIM(STR(INT(nRowFin)))+")"
                      cRanPe:=cRanPe+"+SUM.IF(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe3+"%;T"+ALLTRIM(STR(INT(nRowIni2)))+":T"+ALLTRIM(STR(INT(nRowFin)))+")"
                   ENDIF
*/
*****AG20170926
...
/*
                   IF nI=6
                      cRanPe:=cRanPe+"+SUMAR.SI(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe2+"%;U"+ALLTRIM(STR(INT(nRowIni2)))+":U"+ALLTRIM(STR(INT(nRowFin)))+")"
                      cRanPe:=cRanPe+"+SUMAR.SI(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe3+"%;U"+ALLTRIM(STR(INT(nRowIni2)))+":U"+ALLTRIM(STR(INT(nRowFin)))+")"
                   ENDIF
*/
*****AG20170926
...
/*
                   IF nI=6
                      cRanPe:=cRanPe+"+SUM.IF(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe2+"%;U"+ALLTRIM(STR(INT(nRowIni2)))+":U"+ALLTRIM(STR(INT(nRowFin)))+")"
                      cRanPe:=cRanPe+"+SUM.IF(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe3+"%;U"+ALLTRIM(STR(INT(nRowIni2)))+":U"+ALLTRIM(STR(INT(nRowFin)))+")"
                   ENDIF
*/
*****AG20170926
                ENDIF
...
/*
                   IF nI=6
                      cRanPe:=cRanPe+"+SUMAR.SI(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe2+"%;V"+ALLTRIM(STR(INT(nRowIni2)))+":V"+ALLTRIM(STR(INT(nRowFin)))+")"
                      cRanPe:=cRanPe+"+SUMAR.SI(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe3+"%;V"+ALLTRIM(STR(INT(nRowIni2)))+":V"+ALLTRIM(STR(INT(nRowFin)))+")"
                   ENDIF
*/
*****AG20170926
...
/*
                   IF nI=6
                      cRanPe:=cRanPe+"+SUM.IF(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe2+"%;V"+ALLTRIM(STR(INT(nRowIni2)))+":V"+ALLTRIM(STR(INT(nRowFin)))+")"
                      cRanPe:=cRanPe+"+SUM.IF(S"+ALLTRIM(STR(INT(nRowIni2)))+":S"+ALLTRIM(STR(INT(nRowFin)))+";"+nPorPe3+"%;V"+ALLTRIM(STR(INT(nRowIni2)))+":V"+ALLTRIM(STR(INT(nRowFin)))+")"
                   ENDIF
*/
*****AG20170926
                ENDIF
...
// MsgInfo("Retenciones no declaradas")
         ...
         DO WHILE lRetAju .AND. !oTable:Eof() .AND. oTable:RTI_FECHA<=dFecha2
            ...
            oTableDoc:=OpenTable(cSql)
            // DR20110915a. Si la variable lVRetFec está activa se evalúa la fecha, y no el mes
/*
// DR20120316a
